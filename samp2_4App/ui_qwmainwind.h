...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/about.BMP"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        menuBar->setGeometry(QRect(0, 0, 979, 28));
